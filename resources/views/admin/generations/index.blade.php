    ...
    <div class="col-xl-12 col-lg-12 col-xxl-12 col-sm-12">
        <div class="card">
            ...
            <div class="card-header">
                <h4 class="card-title">Все поколения</h4>
                <a href="{{ route('admin.generation.add') }}" class="btn btn-primary">Добавить поколение</a>
            </div>
            <div class="card-body">
                                ...
                                <td>
                                    <div class="dropdown custom-dropdown mb-0">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(40px, 41px, 0px);">
                                            <a class="dropdown-item" href="{{ route('admin.generation.edit', $order->id) }}">Редактировать</a>
                                            <a class="dropdown-item text-danger" href="{{ route('admin.generation.destroy', $order->id) }}">Удалить</a>
                                        </div>
                                    </div>
                                </td>
