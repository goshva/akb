    ...
    <div class="col-xl-12 col-lg-12 col-xxl-12 col-sm-12">
        <div class="card">
            ...
            <div class="card-header">
                <h4 class="card-title">Все артиклы с марками и моделями</h4>
                <a href="{{ route('admin.article.add') }}" class="btn btn-primary">Добавить артикл</a>
            </div>
            <div class="card-body">
                <div class="table-responsive recentOrderTable">
                    <table class="table verticle-middle table-responsive-md">
                        ...
                        @foreach($brands as $brand)
                            <tr>
                                <td>{{ $brand->id }}</td>
                                <td>{{ $brand->marks->name }}/{{ $brand->models->name }}</td>
                                ...
                                <td>
                                    <div class="dropdown custom-dropdown mb-0">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(40px, 41px, 0px);">
                                            <a class="dropdown-item text-danger" href="{{ route('admin.article.edit', $brand->id) }}">Редактировать</a>
                                            <a class="dropdown-item text-danger" href="{{ route('admin.article.destroy', $brand->id) }}">Удалить</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
