    ...
    ***********************************-->
    <div class="nav-header">
        <a href="{{ route('admin') }}" class="brand-logo">
            ...
            <img class="brand-title" src="/img/Logo.png" alt="">
        </a>
        ...
        <div class="deznav-scroll">
            <ul class="metismenu" id="menu">
                <li class="mm-active"><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <span class="nav-text">Дашбоард</span>
                    </a>
                    <ul aria-expanded="false" class="mm-collapse mm-show">
                        <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Категории</a>
                            <ul aria-expanded="false">
                                <li><a href="{{ route('admin.categories') }}">Все категории</a></li>
                                <li><a href="{{ route('admin.add.category') }}">Добавить</a></li>
                            </ul>
                        </li>
                        <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Товары</a>
                            <ul aria-expanded="false">
                                <li><a href="{{ route('admin.products') }}">Все товары</a></li>
                                <li><a href="{{ route('admin.add.product') }}">Добавить</a></li>
                            </ul>
                        </li>
                        <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Бренды</a>
                            <ul aria-expanded="false">
                                <li><a href="{{ route('admin.brands') }}">Все бренды</a></li>
                                <li><a href="{{ route('admin.add.brand') }}">Добавить</a></li>
                            </ul>
                        </li>
                ...
                <li class=""><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <ul aria-expanded="false" class="">
                        <li>
                            <a class="" href="{{ route('admin.settings') }}" aria-expanded="false">Общие настройки</a>
                        </li>
                    </ul>
                </li>
                <li class=""><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <ul aria-expanded="false" class="">
                        <li>
                            <a class="" href="{{ route('admin.orders') }}" aria-expanded="false">Все</a>
                        </li>
                    </ul>
                </li>
                <li class=""><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <ul aria-expanded="false" class="">
                        <li>
                            <a class="" href="{{ route('admin.marks') }}" aria-expanded="false">Марки</a>
                            <a class="" href="{{ route('admin.models') }}" aria-expanded="false">Модели</a>
                            <a class="" href="{{ route('admin.generations') }}" aria-expanded="false">Поколения</a>
                            <a class="" href="{{ route('admin.engines') }}" aria-expanded="false">Движки</a>
                        </li>
                    </ul>
                </li>
                <li class="">
                    <a class="ai-icon" href="{{ route('admin.articles') }}" aria-expanded="false">
                        <i class=""></i>
                        <span class="nav-text">Артиклы</span>
                    </a>
                </li>
            </ul>
